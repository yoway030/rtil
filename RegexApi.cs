...
namespace rtil.api
{
    class RegexApi
    {
        public static IResult RegexMatch(RegexMatchRequest request)
        {
        ...
        public static IResult RegexCapture(RegexCaptureRequest request)
        {
            if (request.text == null ||
                request.pattern == null)
            {
        ...
        public static IResult RegexReplace(RegexReplaceRequest request)
        {
            if (request.text == null ||
                request.pattern == null ||
                request.to == null)
